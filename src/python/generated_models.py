...
#   timestamp: 2025-12-01T10:05:11+00:00
...
class AgentActionType(Enum):
    """
    Type of agent action requiring confirmation
    """
...
class OptimizeGeometry(Enum):
    """
    Geometry optimization not available for CCSD
    """
...
class CCSDCalculationRequest(CalculationRequestBase):
    ...
    optimize_geometry: Optional[OptimizeGeometry] = Field(
        False, description='Geometry optimization not available for CCSD'
    )
...
class OptimizeGeometry1(Enum):
    """
    Geometry optimization not available for CCSD(T)
    """
...
class CCSDTCalculationRequest(CalculationRequestBase):
    ...
    optimize_geometry: Optional[OptimizeGeometry1] = Field(
        False, description='Geometry optimization not available for CCSD(T)'
    )
...
class OptimizeGeometry2(Enum):
    """
    Geometry optimization not available for TDDFT
    """
...
class TDDFTCalculationRequest(CalculationRequestBase):
    ...
    optimize_geometry: Optional[OptimizeGeometry2] = Field(
        False, description='Geometry optimization not available for TDDFT'
    )
...
class OptimizeGeometry3(Enum):
    """
    Geometry optimization not available for CASCI
    """
...
class CASCICalculationRequest(CalculationRequestBase):
    ...
    optimize_geometry: Optional[OptimizeGeometry3] = Field(
        False, description='Geometry optimization not available for CASCI'
    )
...
class OptimizeGeometry4(Enum):
    """
    Geometry optimization not available for CASSCF
    """
...
class CASSCFCalculationRequest(CalculationRequestBase):
    ...
    optimize_geometry: Optional[OptimizeGeometry4] = Field(
        False, description='Geometry optimization not available for CASSCF'
    )
...
class ExecuteConfirmedActionRequest(BaseModel):
...
class Data14(BaseModel):
    ...
    calculation_id: Optional[str] = Field(
        None, description='ID of the affected calculation'
    )


class ExecuteConfirmedActionResponse(BaseModel):
    success: bool = Field(..., examples=[True])
    data: Data14
