...
#   timestamp: 2025-08-20T05:02:19+00:00
...
class MullikenCharge(BaseModel):
    atom_index: int = Field(..., description='Index of the atom (0-based)')
    atom_symbol: str = Field(..., description='Atomic symbol (e.g., H, C, N, O)')
    mulliken_charge: float = Field(
