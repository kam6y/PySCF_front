...
#   timestamp: 2025-08-11T02:46:32+00:00
...
class QuantumCalculationRequest(BaseModel):
    ...
    basis_function: Optional[str] = Field(
        '6-31G(d)', description='Basis function for calculation'
    )
    ...
    solvent: Optional[str] = Field('-', description='Solvent type')
...
class XYZValidateResponse(BaseModel):
    success: bool = Field(..., examples=[True])
    data: Dict[str, Any] = Field(..., description='Validation result')
...
class Data5(BaseModel):
    ...
    old_id: str = Field(..., description='Previous calculation ID')
    new_id: str = Field(..., description='New calculation ID')
    new_name: str = Field(..., description='New calculation name')
