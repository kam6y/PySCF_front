...
export const CIAnalysisViewer: React.FC<CIAnalysisViewerProps> = React.memo(
  ({ enhancedCiAnalysis, ciCoefficientsAvailable, kernelReturnInfo }) => {
      ...
      return (
        <div className={styles.error}>
          ...
          <p className={styles.errorMessage}>
            Error: {enhancedCiAnalysis.error}
          </p>
        </div>
      );
    }
              ...
              <div className={styles.configTable}>
                ...
                {enhancedCiAnalysis.major_configurations.length > 20 && (
                  <div className={styles.configTableNote}>
                    ... and{' '}
                    {enhancedCiAnalysis.major_configurations.length - 20} more
                    configurations
                  </div>
                )}
              </div>
