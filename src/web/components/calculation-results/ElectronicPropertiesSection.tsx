...
export const ElectronicPropertiesSection =
  React.memo<ElectronicPropertiesSectionProps>(
    ({ results, parameters, activeCalculation }) => {
      return (
        <section
          ...
          {results.dipole_moment_total_debye != null && (
            <div className={styles.propertySubsection}>
              ...
              <div className={styles.sectionDescription}>
                Electric dipole moment quantifies the separation of positive and
                negative charges in the molecule.
              </div>
                  ...
                  <table className={styles.dipoleTable}>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className={styles.rightAlign}>
                          <code>{results.dipole_moment_x_au?.toFixed(4)}</code>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td className={styles.rightAlign}>
                          <code>{results.dipole_moment_y_au?.toFixed(4)}</code>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td className={styles.rightAlign}>
                          <code>{results.dipole_moment_z_au?.toFixed(4)}</code>
                        </td>
                      </tr>
            ...
            (results as any).mulliken_spin_analysis.available && (
              <div className={styles.propertySubsection}>
                ...
                <div className={styles.sectionDescription}>
                  ...
                  unpaired electron density across atoms in open-shell systems.
                </div>
                ...
                {(results as any).mulliken_spin_analysis
                  ...
                  (results as any).mulliken_spin_analysis.atomic_spin_densities
                    .length > 0 && (
