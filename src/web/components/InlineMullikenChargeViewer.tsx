...
export const InlineMullikenChargeViewer: React.FC<InlineMullikenChargeViewerProps> =
  React.memo(({ calculation_id, height = 400, onError }) => {
    ...
    const renderMoleculeWithCharges = useCallback(() => {
      ...
      try {
        ...
        viewer.setStyle(
          {},
          { stick: { radius: 0.15 }, sphere: { radius: 0.4 } }
        );
      ...
      return (
        <div className={styles.container}>
          <div className={styles.errorContainer}>
            ...
            <div className={styles.errorDetail}>
              This calculation does not contain Mulliken population analysis
              data.
            </div>
          </div>
        </div>
